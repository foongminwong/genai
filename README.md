...
4. ChatGPT Prompt Engineering, Role Prompts, and Chain Prompting

5. Introduction to the OpenAI Chat Completions API 

6. Introduction to GitHub CoPilot

7. Amazon CodeWhisperer: Generating Code with AI 

8. Understanding the Azure Open AI Service

9. Introduction to AI Copilot in Microsoft Power Apps 

10. Introduction to AI Copilot in Microsoft Power Virtual Agents

11. Introduction to Google Generative AI Studio